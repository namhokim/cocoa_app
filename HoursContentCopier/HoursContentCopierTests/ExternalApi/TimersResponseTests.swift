...
class TimersResponseTests: XCTestCase {
    ...
    func testFromJsonData_fail_loginRequired() {
        // given
        let timerResponse = #"{"status":"error","error_code":401,"error_message":"Login Required."}"#
